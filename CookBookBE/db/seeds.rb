...
k1 = Keyword.create(keyword:'Gross')
k2 = Keyword.create(keyword:'Nasty')
k3 = Keyword.create(keyword:'1 Star')
k4 = Keyword.create(keyword:'Trash')
k5 = Keyword.create(keyword:'No')
k6 = Keyword.create(keyword:'Low Effort')
